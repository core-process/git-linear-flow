...
alice 'git merge feature/backend'
alice 'git push'
...
eve 'git pull --no-edit'

################################################################################
section "SYNC FRONTEND BRANCHES 1"

eve 'git push'
bob 'git pull --no-edit'

################################################################################
section "MERGE FRONTEND ONTO DEVELOP"

bob 'git fetch --all && git merge --no-edit origin/develop'
bob 'git push'
...
eve 'git checkout develop && git pull --no-edit'
eve 'git merge --no-edit feature/frontend'
eve 'git push'
